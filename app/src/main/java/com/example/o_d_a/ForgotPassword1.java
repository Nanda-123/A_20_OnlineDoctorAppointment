...
public class ForgotPassword1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mforgotpassword=findViewById(R.id.forgotpassword1);
        mpasswordrecoverbutton=findViewById(R.id.passwordrecoverbutton1);
        ...
        mgobacktologin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ForgotPassword1.this,admin_Login.class);
                    ...
                    firebaseAuth.sendPasswordResetEmail(mail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful())
                            {
                                ...
                                finish();
                                startActivity(new Intent(ForgotPassword1.this, admin_Login.class));
                            }
                            else
                            {
