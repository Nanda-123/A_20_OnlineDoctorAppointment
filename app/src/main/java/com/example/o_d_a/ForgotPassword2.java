...
public class ForgotPassword2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mforgotpassword=findViewById(R.id.forgotpassword2);
        mpasswordrecoverbutton=findViewById(R.id.passwordrecoverbutton2);
        mgobacktologin=findViewById(R.id.GoToLogin1);
        ...
        mgobacktologin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ForgotPassword2.this,doctor_Login.class);
                    ...
                    firebaseAuth.sendPasswordResetEmail(mail).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful())
                            {
                                ...
                                finish();
                                startActivity(new Intent(ForgotPassword2.this, doctor_Login.class));
                            }
                            else
                            {
